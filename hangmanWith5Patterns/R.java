 ...
 * @version v1.0
 */
public class R implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "R";
    private static final int X_LOCATION = Position.R.x;
    private static final int Y_LOCATION = Position.R.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public R(Alphabet alphabetSubject)  {
