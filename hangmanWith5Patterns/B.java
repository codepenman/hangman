 ...
 * @version v1.0
 */
public class B implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "B";
    private static final int X_LOCATION = Position.B.x;
    private static final int Y_LOCATION = Position.B.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public B(Alphabet alphabetSubject)  {
