 ...
 * @version v1.0
 */
public class V implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "V";
    private static final int X_LOCATION = Position.V.x;
    private static final int Y_LOCATION = Position.V.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public V(Alphabet alphabetSubject)  {
