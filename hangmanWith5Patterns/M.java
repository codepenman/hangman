 ...
 * @version v1.0
 */
public class M implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "M";
    private static final int X_LOCATION = Position.M.x;
    private static final int Y_LOCATION = Position.M.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public M(Alphabet alphabetSubject)  {
