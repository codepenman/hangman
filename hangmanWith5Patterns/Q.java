 ...
 * @version v1.0
 */
public class Q implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "Q";
    private static final int X_LOCATION = Position.Q.x;
    private static final int Y_LOCATION = Position.Q.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public Q(Alphabet alphabetSubject)  {
