 ...
 * @version v1.0
 */
public class J implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "J";
    private static final int X_LOCATION = Position.J.x;
    private static final int Y_LOCATION = Position.J.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public J(Alphabet alphabetSubject)  {
