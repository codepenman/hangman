 ...
 * @version v1.0
 */
public class T implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "T";
    private static final int X_LOCATION = Position.T.x;
    private static final int Y_LOCATION = Position.T.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public T(Alphabet alphabetSubject)  {
