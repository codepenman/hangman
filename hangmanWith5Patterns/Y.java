 ...
 * @version v1.0
 */
public class Y implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "Y";
    private static final int X_LOCATION = Position.Y.x;
    private static final int Y_LOCATION = Position.Y.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public Y(Alphabet alphabetSubject)  {
