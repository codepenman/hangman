 ...
 * @version v1.0
 */
public class N implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "N";
    private static final int X_LOCATION = Position.N.x;
    private static final int Y_LOCATION = Position.N.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public N(Alphabet alphabetSubject)  {
