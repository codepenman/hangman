 ...
 * @version v1.0
 */
public class P implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "P";
    private static final int X_LOCATION = Position.P.x;
    private static final int Y_LOCATION = Position.P.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public P(Alphabet alphabetSubject)  {
