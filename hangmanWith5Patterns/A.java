 ...
 * @version v1.0
 */
public class A implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "A";
    private static final int X_LOCATION = Position.A.x;
    private static final int Y_LOCATION = Position.A.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public A(Alphabet alphabetSubject)  {
