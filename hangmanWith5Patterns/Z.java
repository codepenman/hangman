 ...
 * @version v1.0
 */
public class Z implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "Z";
    private static final int X_LOCATION = Position.Z.x;
    private static final int Y_LOCATION = Position.Z.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public Z(Alphabet alphabetSubject)  {
