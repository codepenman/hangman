 ...
 * @version v1.0
 */
public class F implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "F";
    private static final int X_LOCATION = Position.F.x;
    private static final int Y_LOCATION = Position.F.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public F(Alphabet alphabetSubject)  {
