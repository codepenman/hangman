 ...
 * @version v1.0
 */
public class U implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "U";
    private static final int X_LOCATION = Position.U.x;
    private static final int Y_LOCATION = Position.U.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public U(Alphabet alphabetSubject)  {
