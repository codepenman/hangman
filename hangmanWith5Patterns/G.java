 ...
 * @version v1.0
 */
public class G implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "G";
    private static final int X_LOCATION = Position.G.x;
    private static final int Y_LOCATION = Position.G.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public G(Alphabet alphabetSubject)  {
