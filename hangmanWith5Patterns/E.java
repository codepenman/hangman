 ...
 * @version v1.0
 */
public class E implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "E";
    private static final int X_LOCATION = Position.E.x;
    private static final int Y_LOCATION = Position.E.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public E(Alphabet alphabetSubject)  {
