 ...
 * @version v1.0
 */
public class L implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "L";
    private static final int X_LOCATION = Position.L.x;
    private static final int Y_LOCATION = Position.L.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public L(Alphabet alphabetSubject)  {
