 ...
 * @version v1.0
 */
public class C implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "C";
    private static final int X_LOCATION = Position.C.x;
    private static final int Y_LOCATION = Position.C.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public C(Alphabet alphabetSubject)  {
