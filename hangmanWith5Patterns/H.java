 ...
 * @version v1.0
 */
public class H implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "H";
    private static final int X_LOCATION = Position.H.x;
    private static final int Y_LOCATION = Position.H.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public H(Alphabet alphabetSubject)  {
