 ...
 * @version v1.0
 */
public class O implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "O";
    private static final int X_LOCATION = Position.O.x;
    private static final int Y_LOCATION = Position.O.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public O(Alphabet alphabetSubject)  {
