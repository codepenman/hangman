 ...
 * @version v1.0
 */
public class X implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "X";
    private static final int X_LOCATION = Position.X.x;
    private static final int Y_LOCATION = Position.X.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public X(Alphabet alphabetSubject)  {
