 ...
 * @version v1.0
 */
public class S implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "S";
    private static final int X_LOCATION = Position.S.x;
    private static final int Y_LOCATION = Position.S.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public S(Alphabet alphabetSubject)  {
