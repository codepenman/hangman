 ...
 * @version v1.0
 */
public class D implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "D";
    private static final int X_LOCATION = Position.D.x;
    private static final int Y_LOCATION = Position.D.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public D(Alphabet alphabetSubject)  {
