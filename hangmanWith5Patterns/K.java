 ...
 * @version v1.0
 */
public class K implements IMouseClickHandler, IKeyPressHandler, IAlphabet
{
    private static final String ALPHABET = "K";
    private static final int X_LOCATION = Position.K.x;
    private static final int Y_LOCATION = Position.K.y;
    private IInputHandler nextHandler;
    private Alphabet alphabetSubject;         
    
    public K(Alphabet alphabetSubject)  {
